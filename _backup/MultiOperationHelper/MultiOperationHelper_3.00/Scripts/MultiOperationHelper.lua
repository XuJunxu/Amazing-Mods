...
function MultiOperationHelper:AddBtn(thing, opt, tooltips)
	tooltips = tooltips or opt.tooltips;
	thing:AddBtnData(opt.dspName, opt.icon, self:GetBtnLua(opt.data, opt.dspName), tooltips, nil);
end
...
function MultiOperationHelper:MultiRefiningFabao(npc)  --设置批量炼宝
	...
	local tips = {
		title = "说明",
		content = "按住左Shift键，鼠标点选物品；若物品的堆叠数>1，则可以设置个数。"
	};	
...
MultiOperationHelper.magic_tips = {
	["SeachSoul"] = "按住左Shift键，鼠标点选小人",
	["SoulCrystalYouPowerUp"] = "按住左Shift键，鼠标点选物品。若物品的堆叠数=1，则可以设置幽淬的次数；若物品的堆叠数>1，则可以设置幽淬的个数。幽淬次数范围0--12，幽淬个数范围0--99。",
	["FengshuiItemOpen"] = "按住左Shift键，鼠标点选物品。",
	["AbsorbLing_Item"] = "按住左Shift键，鼠标点选物品",
};
...
MultiOperationHelper.operationDef = {
	...
	multiEatItem = {dspName = "多人食用", icon = "res/Sprs/ui/icon_shiyong01", data = "MultiEatItem", tooltips = "选择单个或多个小人，食用同品阶同名称的物品，并可设置连续食用多次（包括体修的吞噬等）。"};
	multiEquiptItem = {dspName = "多人装备", icon = "res/Sprs/ui/icon_zhuangbeidaoju01", data = "MultiEquiptItem", tooltips = "选择单个或多个小人，装备同品阶同材料的物品。"};
	multiFuPainter = {dspName = "批量画符", icon = "res/Sprs/ui/icon_huafu01", data = "MultiFuPainter", tooltips = "使用同品阶同类型的符纸，进行批量画符，可设置画多种不同的符咒。"};
	multiPutItem = {dspName = "批量放置", icon = "res/Sprs/ui/icon_fangzhiwupin01", data = "MultiPutItem", tooltips = "选择单个或多个置物台，放置同品阶同名称的物品。"};
	multiRefiningFabao = {dspName = "批量炼宝", icon = "res/Sprs/ui/icon_lianbao01", data = "MultiRefiningFabao", tooltips = "选择单个或多个物品，自动进行炼宝。"};
	cancelRefiningFabao = {dspName = "取消批量炼宝", icon = "res/Sprs/ui/icon_lianbao01", data = "CancelRefiningFabao", tooltips = "取消所有剩余的炼宝任务，正在炼制的法宝不会被取消。"};
};
